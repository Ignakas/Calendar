...
class CalendarLogic: Hashable {
   ...
   private func calculateCurrentMonthVisibleDays() -> [Date] {
      var dates = [Date]()
   ...
   private func calculatePreviousMonthVisibleDays() -> [Date] {
      var dates = [Date]()
   ...
   private func calculateFollowingMonthVisibleDays() -> [Date] {
      var dates = [Date]()
